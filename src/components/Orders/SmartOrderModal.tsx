...
export default function SmartOrderModal({ isOpen, onClose, order, initialTab = 'tracking' }: SmartOrderModalProps) {
											...
											<div className="grid grid-cols-1 md:grid-cols-2 gap-24 p-16 sm:p-28">
												...
												<div className="md:text-right space-y-12">
													...
													<div className="space-y-4 md:pr-12">
														...
														<p className="text-[11px] font-black text-[#003c1b] uppercase tracking-[0.5em] pt-12 opacity-30 italic">Priority Door-to-Door Fulfillment Protocol</p>
													</div>
												</div>
											</div>
													...
													<div className="space-y-14">
														<div className="space-y-7">
															...
															<div className="flex justify-between items-center text-[12px] font-black uppercase tracking-[0.6em] text-emerald-400">
																<span>Logistic Deployment Deployment</span>
																<span className="font-mono text-xl italic">{order.shippingPrice === 0 ? 'NOMINAL' : `${order.shippingPrice} EGP`}</span>
															</div>
														</div>
														<div className="pt-16 border-t border-white/10 flex justify-between items-end">
															<div className="space-y-4">
																<p className="text-[13px] font-black uppercase tracking-[0.7em] text-emerald-400 leading-none">Net Transaction Value</p>
																<p className="text-9xl font-black text-white tracking-[calc(-0.06em)] italic leading-none">{order.totalOrderPrice.toLocaleString()} <span className="text-sm uppercase opacity-30 font-bold not-italic font-sans tracking-[0.5em] ml-4 italic">EGP</span></p>
															</div>
														</div>
													</div>
												</div>
