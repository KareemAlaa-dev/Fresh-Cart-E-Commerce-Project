					...
					>
						...
						>
							<div className="text-center">
								<Link
									href="/forgotpassword"
									className="text-sm text-[#003c1b] font-bold hover:underline transition-all"
								>
									Forgot Password?
								</Link>
							</div>
					...
					<div className="relative z-10 text-white max-w-lg">
						...
						>
							<h2 className="text-4xl xl:text-5xl font-black mb-6 leading-tight">
								Continue Your Fresh Journey
							</h2>
							<p className="text-lg text-white/80 mb-8 leading-relaxed">
								Access your account to track orders, manage your wishlist, and discover new organic products.
							</p>
						</motion.div>
						...
						>
							{[
								...
								{ icon: Leaf, text: "Personalized Recommendations" }
							].map((feature, index) => (
								<motion.div
									key={index}
									initial={{ opacity: 0, x: -20 }}
